...
class ControladorVentas{
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
				...
				try{
					...
					$imprimir -> text( "Inventory System" . "\n");
					$imprimir -> text( "NIT 767900-2" . "\n");
					$imprimir -> text( "Dir. 3a calle 3-15" . "\n");
					$imprimir -> text( "Tel. 2334-3223" . "\n");
					$imprimir -> text( "Fac No." . $_POST["nuevaVenta"] . "\n");
					$imprimir -> feed(1);

					$imprimir -> text( "Client: " . $traerCliente["nombre"] . "\n");
					...
					$imprimir -> text( "Client: " . $traerVendedor["nombre"] . "\n");
					$imprimir -> feed(1);
					...
					foreach ($productos as $key => $value) {
						...
						$imprimir -> text( "$ " . number_format($value["precio"],2) . " Und x " . $value["cantidad"] . " $ " . number_format( $value["total"], 2 ) . "\n" );

					}
					$imprimir -> feed(1);

					$imprimir -> text( "NETO: $ " . number_format($_POST
					["nuevoPrecioNeto"],2) .  "\n" );
					$imprimir -> text( "NETO: $ " . number_format($_POST["nuevoPrecioImpuesto"],2) .  "\n" );

					$imprimir -> text( "----------\n" );

					$imprimir -> text( "NETO: $ " . number_format($_POST["totalVenta"],2) .  "\n" );
					$imprimir -> feed(1);
	...
	static public function ctrDescargarXML(){
		if(isset($_GET["xml"])){
			...
			// $objetoXML -> writeAttribute("atributoEtiquetaPpal", "Valor");
			
			// $objetoXML ->startElement("EtiquetaInterna");
			// $objetoXML -> writeAttribute("atributoEtiquetaInterna", "Valor 2");
