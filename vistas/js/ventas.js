    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            $(".nuevoProducto").append(
                ...
                '<button type="button" class="btn btn-danger quitarProducto" idProducto="' + idProducto + '"><i class="fa fa-times"></i></button>' +
                '</div>' +
    ...
    $.ajax({
        ...
        success: function(respuesta) {
            ...
            $(".nuevoProducto").append(
                ...
                '<select class="form-control nuevaDescripcionProducto"  idProducto name="nuevaDescripcionProducto" id="producto' + numProducto + '" required>' +
                '<option></option>' +
                '</select>' +
                '</div>' +
...
$("#nuevoMetodoPago").change(function() {
    ...
    if (metodo == "Efectivo") {
        ...
        $(this).parent().parent().parent().children(".cajasMetodoPago").html(
            ...
            '</div>' +
            '<input type="text" class="form-control" id="nuevoValorEfectivo" id="nuevoValorEfectivo" placeholder="00" required>' +
            '</div>' +
            '</div>' +
            ...
            ' <span class="input-group-text" id="basic-addon1">$</span>' +
            '</div>' +
            '<input type="text" class="form-control" name="nuevoCambioEfectivo" id="nuevoCambioEfectivo" placeholder="00" readonly required>' +
            '</div>' +
            '</div></div>'
        ...
        $(this).parent().parent().parent().children('.cajasMetodoPago').html(
            ...
            ' <span class="input-group-text" id="basic-addon1">$</span>' +
            '</div>' +
            '<input type="text" class="form-control nuevoValorEfectivo" id="nuevoCodigoTransaccion" placeholder="Código transacción" required>' +
            '</div>' +
            '</div></div>')
...
$(".formularioVenta").on("change", "input#nuevoValorEfectivo", function() {
    ...
    var nuevoCambioEfectivo = $(this).parent().parent().parent().parent().children('#capturarCambioEfectivo').children().children('#nuevoCambioEfectivo');
