...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Página no encontrada<small style="color: grey; font-size:16px;">Panel de control</small></h1>
    ...
    <section class="content">
        <div class="error-page">
            ...
            <div class="error-content">
                ...
                <p>Ingresa al menú lateral y allí podrás encontrar las páginas disponibles.
